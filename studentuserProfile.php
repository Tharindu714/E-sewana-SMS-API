...
<head>
  ...
  <title>User Profile | e - SEWANA</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      if (isset($_SESSION["user"])) {
        ...
        $details_resultSet = Database::search("SELECT * FROM `student` INNER JOIN `gender` ON 
        gender.gender_id=student.gender_id WHERE `email`= '" . $email . "';");

        $img_resultSet = Database::search("SELECT*FROM `profile_img` WHERE `student_email`='" . $email . "';");

        $addr_resultSet = Database::search("SELECT*FROM `student_has_address`
        INNER JOIN `city` ON student_has_address.city_id=city.id
        INNER JOIN `district` ON city.district_id=district.id
        INNER JOIN `province`ON district.province_id=province.id WHERE `student_email`='" . $email . "';");
              ...
              <div class="row g-2">
                ...
                <div class="col-md-3 border-end main-body">
                  <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <label for="profileimg" class="btn mt-5 text-light text-uppercase fw-bold border border-2 border-light" onclick="changeimg();" style="background-color: #033d2a;">Update Profile Image</label>
                  ...
                  <div class="p-3 py-5">
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-12 d-grid mt-3">
                        <button class="btn text-light text-uppercase fw-bold border border-2 border-light" style="background-color: #150135;" onclick="updatePro();">Update My Profile</button>
                      </div>
