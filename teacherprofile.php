...
<head>
  ...
  <title>Teacher's Profile | e - SEWANA</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      if (isset($_SESSION["teacher"])) {
        ...
        $details_resultSet = Database::search("SELECT * FROM `teacher` INNER JOIN `gender` ON 
        gender.gender_id=teacher.gender_id WHERE `email`= '" . $email . "';");

        $img_resultSet = Database::search("SELECT*FROM `teacher_profile_img` WHERE `teacher_email`='" . $email . "';");

        $addr_resultSet = Database::search("SELECT*FROM `teacher_has_address`
        INNER JOIN `city` ON teacher_has_address.city_id=city.id
        INNER JOIN `district` ON city.district_id=district.id
        INNER JOIN `province`ON district.province_id=province.id WHERE `teacher_email`='" . $email . "';");
              ...
              <div class="row g-2">
                ...
                <div class="col-md-3 border-end main-body">
                  <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <label for="profileimg" class="btn mt-5 text-light text-uppercase fw-bold border border-2 border-light" onclick="changeimg1();" style="background-color: #033d2a;">Update Profile Image</label>
                  ...
                  <div class="p-3 py-5">
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-12 d-grid mt-3">
                        <button class="btn text-light text-uppercase fw-bold border border-2 border-light" style="background-color: #150135;" onclick="updatePro1();">Update My Profile</button>
                      </div>
