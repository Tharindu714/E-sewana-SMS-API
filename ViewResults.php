...
<head>
  ...
  <title>Your Results | E- Sewana</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-12 bg-light text-center">
        <label class="form-label text-primary fw-bold fs-1 text-uppercase">Your Assignment Marks</label>
      </div>
      ...
      <div class="row border-bottom border-dark">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Your Assignment Marks</li>
          </ol>
        </nav>
      </div>
      ...
      <div class="col-12 mt-3 mb-3">
        ...
        for ($x = 0; $x < $selected_num; $x++) {
          ...
          while ($info = mysqli_fetch_array($query1)) {
            ...
            $smark_rs = Database::search("SELECT * FROM `student_mark` WHERE `assignment_mark_id` ='" . $mark_data['id'] . "'");
            $smark_data = $smark_rs->fetch_assoc();
        ...
        ?>
            ...
            <div class="col-12">
              <div class="row mb-3 mt-3">
                ...
                <div class="col-1 d-lg-block bg-light py-2">
                  <span class="fs-4"><?php echo $smark_data['mark']; ?></span>
                </div>
