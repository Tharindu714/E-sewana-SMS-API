...
<head>
  ...
  <title>e - SEWANA | Submit Marks</title>
    ...
    <div class="row align-content-center">
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div class="col-12">
            <p class="text-center title1">e- SEWANA Marking Portal</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 p-5">
        <div class="row">
          ...
          <div class="col-12 col-lg-6 d-block">
            <div class="row g-3">
              <div class="col-12">
                <p class="title2 text-uppercase">Submit Assignment Marks</p>
              </div>
              ...
              <div class="col-12 col-lg-6 d-grid">
                <button class="btn btn-success text-uppercase fw-bold" onclick="submitMarks();" > Submit Marks</button>
              </div>
              <div class="col-12 col-lg-6 d-grid">
                <button class="btn btn-danger text-uppercase fw-bold" onclick="window.location ='Assignment.php';">Back to Assignments</button>
              </div>
            </div>
