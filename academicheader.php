    ...
    <div class="row mt-1 mb-1">
      ...
      <div class="offset-lg-1 col-12 col-lg-3 align-self-start mt-2">
        ...
        ?>
          ...
          <span class="text-lg-start link link-dark welcome text-uppercase fs-6" title="Officer name"><?php echo $data["fname"]; ?></span> |
        ...
        ?>
          ...
          <a href="academicindex.php" class="btn text-light text-decoration-none fw-bold text-uppercase" style="background-color: #ce0167;"><img src="resource\refresh.svg" style="width:25px;" /> Register</a>
        ...
        <div class="row">
          <div class="col-2 col-lg-6 dropdown">
            ...
            <ul class="dropdown-menu" style="background-color: #4ce9a0;">
              <li><a class="dropdown-item" href="academichome.php">Home page</a></li>
              <li><a class="dropdown-item" href="academicProfile.php">My Profile</a></li>
              <li><a class="dropdown-item" href="releaseMarks.php">Release Assignment Mark</a></li>
