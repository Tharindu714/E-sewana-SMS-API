...
?>
  ...
  <head>
    ...
    <title> My Assignments | e - SEWANA </title>
    <style media="screen">
      embed {
      ...
      <div class="row">
            ...
            <div class="col-12 col-lg-8 ">
              <div class="row">
                <div class="col-12 col-lg-9 mt-2 my-lg-4">
                  <h1 class="offset-4 offset-lg-2 text-primary text-uppercase fw-bold">My Assignments</h1>
                </div>
                <div class="col-1 col-lg-1 my-lg-4 mx-2 mx-lg-0" title="Marking" onclick='window.location = "marking.php"'><i class="bi bi-book fs-3"></i></div>
                <div class="col-12 col-lg-2 mb-2 my-lg-4 mx-2 mx-lg-0 d-grid">
                  <a href="AddAS.php" class="btn btn-outline-light fw-bold text-red-50 text-center mb-3">Add here</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-12 border-0 border-end border-1 border-primary">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="assignmentVerification.php">Back</a></li>
