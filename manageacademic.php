...
<head>
    ...
    <title>Manage Academic Officers | Admins</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-primary fw-bold fs-1 text-uppercase">Manage All Academic Officers</label>
            </div>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <div class="col-12 mt-3">
                <div class="row">
                    <div class="offset-0 offset-lg-3 col-12 col-lg-6 mb-3">
                        <div class="row">
                            <div class="col-9">
                                <input type="text" class="form-control" id="mu" placeholder="Search by Officer Name" />
                            </div>
                            <div class="col-3 d-grid">
                                <button class="btn bg-transparent text-uppercase fw-bold text-primary border border-2 border-primary fs-6" title="Search by Officer Name" onclick="searchMU2();">Search Officers</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            for ($x = 0; $x < $selected_num; $x++) {
                ...
                $pro_img_rs = Database::search("SELECT * FROM `acadamic_profile_img` 
                WHERE `academic_officer_email` = '" . $selected_data["email"] . "';");
                ...
                <div class="col-12" id="searchResults">
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-2 col-lg-1 bg-transparent py-2 d-grid">
                            ...
                            ?>
                                <button id="UB<?php echo $selected_data['email']; ?>" class="btn btn-danger rounded-circle text-uppercase fw-bold" onclick="blockUser2('<?php echo $selected_data['email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button id="UB<?php echo $selected_data['email']; ?>" class="btn btn-success rounded-circle text-uppercase fw-bold" onclick="blockUser2('<?php echo $selected_data['email']; ?>');">Unblock</button>
                            <?php
