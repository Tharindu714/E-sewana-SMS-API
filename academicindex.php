...
<head>
    ...
    <title>e - SEWANA | Academic Officers</title>
        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-lg-1 col-2 mt-lg-0 mt-4 link-primary fw-bold"><a href="studentindex.php">Login as a student</a></div>
                    <div class="col-lg-1 col-2 mt-lg-0 mt-4 link-primary fw-bold"><a href="teacherindex.php">Login as a teacher</a></div>
                    <div class="col-12">
                        <p class="text-center title1">e- SEWANA Academic Officer's Portal</p>
                    </div>
                </div>
            </div>
            <!-- header -->
                    ...
                    <div class="col-12 col-lg-6" id="signUpBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn border border-2 border-white text-light text-uppercase fw-bold" onclick="signUp2();" style="background-color: #d11c76;">Sign Up</button>
                            </div>
                            <div class="col-12 col-lg-6 d-grid">
                        ...
                        <div class="col-12 col-lg-6 d-none" id="signInBox">
                            <div class="row g-2">
                                ...
                                <div class="col-6 text-end">
                                    <a href="#" class="link-primary text-uppercase fw-bold" onclick="forgotPassword2();">Forgot Password?</a>
                                </div>
                                <div class="col-12 col-lg-6 d-grid">
                                    <button class="btn border border-2 border-white text-light text-uppercase fw-bold" onclick="signIn2();" style="background-color: #d11c76;">Sign In</button>
                                </div>
                                <div class="col-12 col-lg-6 d-grid">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-outline-secondary" type="button" id="newpassbtn" onclick="ShowPass2();">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-outline-secondary" type="button" id="retypepassbtn" onclick="ShowRetypePass2();">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="resetpass2();">Reset Password</button>
                    </div>
                </div>
            </div>
        </div>
