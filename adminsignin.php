    ...
    <div class="row align-content-center">
      ...
      <div class="col-12">
        <div class="row">
          ...
          <div class="col-12">
            <p class="text-center title1">e- SEWANA Admin's Portal</p>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 d-block">
            <div class="row g-3">
              ...
              <div class="col-12 col-lg-6 d-grid">
                <button class="btn btn-danger" onclick="window.location ='studentindex.php';">Back to student Login</button>
              </div>
            </div>
          </div>
